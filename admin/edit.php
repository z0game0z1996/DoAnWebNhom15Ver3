			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="suahangsx.php" method="post" class="form-horizontal" enctype="multipart/form-data">
							<div class="control-group">
								...
								<?php
									...
									$db = new db;
									$getID = $_GET['ID'];
									$getName = $db->gettenhangsx($getID); 
									/*var_dump($getName);*/
								?>
									<input value="<?php echo $getName[0]['TenHSX'] ?>" type="text" class="span11" placeholder="Product name" name="txtname" />
									<input type="hidden" value="<?php echo $getName[0]['IDHSX'] ?>" name="ID">
								</div>
