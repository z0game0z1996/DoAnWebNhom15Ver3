			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						...
						<!-- BEGIN USER FORM -->
						<form action="sua-sp.php" method="post" class="form-horizontal" enctype="multipart/form-data">
						<?php
							require_once "db.php";
							$db = new db;
							$id = $_GET['id'];
							$getsp = $db->getsanpham($id);
						 ?>
							<div class="control-group">
								<label class="control-label">Name :</label>
								<div class="controls">
									<input value="<?php echo $getsp[0]['TenSP'] ?>" type="text" class="span11" placeholder="Product name" name="txtname" /> *
									<input type="hidden" value="<?php echo $getsp[0]['ID'] ?>" name="id">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Choose a producer :</label>
								<div class="controls">
									<select name="cate_id">
									<?php
										require_once "db.php";
										$db = new db;
										$loaisp = $db->loaisp();
										foreach($loaisp as $rows){ 
									?>
										<option value="<?php echo $rows['IDLoai'] ?>"><?php echo $rows['TenLoai'] ?></option>
									<?php
										} 
									?>
									</select> *
							...
							<div class="control-group">
								...
								<div class="controls">
									...
									?>
										<option value="<?php echo $rows['IDHSX'] ?>"><?php echo $rows['TenHSX'] ?></option>
									<?php
										}
									?>
									</select> *
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea value="" class="span11" placeholder="Description" name = "description"><?php echo $getsp[0]['MoTa'] ?></textarea>
									</div>
									<div class="control-group">
										<label class="control-label">Price :</label>
										<div class="controls">
											<input value="<?php echo $getsp[0]['GiaSP'] ?>" type="text" class="span11" placeholder="price" name = "price" /> *
										</div>
